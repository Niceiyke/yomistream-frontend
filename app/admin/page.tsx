...
export default function SourceSelectionPage() {
  ...
  const initialTab = (searchParams.get("tab") as "selection" | "youtube-sync" | null) ?? "selection"
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">Unified admin system for source selection and YouTube synchronization.</p>
            </div>
          ...
          <Tabs defaultValue={initialTab} className="space-y-8">
            <TabsList className="bg-muted border-border">
              <TabsTrigger value="selection" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Source Selection</TabsTrigger>
              <TabsTrigger value="youtube-sync" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">YouTube Sync</TabsTrigger>
            </TabsList>
                            ...
                            return (
                              <Card key={key} className="bg-white/5 border-white/10 relative overflow-hidden">
                                ...
                                <CardHeader className="space-y-1">
                                  <CardTitle className="text-foreground text-lg line-clamp-1">{video.title}</CardTitle>
                            ...
                            <Table className="min-w-full">
                              <TableHeader>
                                <TableRow className="border-border">
                                  ...
                                  <TableHead className="text-muted-foreground w-[40%]">Title</TableHead>
                                ...
                                {videos.map((video: SourceVideo) => {
                                  ...
                                  return (
                                    <TableRow key={key} className="border-border hover:bg-accent/50">
                                      ...
                                      <TableCell className="text-foreground max-w-[720px]">
                                        <div className="font-semibold line-clamp-1 mb-1">{video.title}</div>
                                        <div className="text-xs text-muted-foreground truncate whitespace-nowrap">{video.description}</div>
                                      </TableCell>
            ...
            <TabsContent value="youtube-sync" className="space-y-6">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">Synchronize YouTube channels and videos with Yomistream.</p>
              </div>
