...
import { Loader2, Plus, Edit, Trash2, Search, Filter, Mic, ChevronDown, ChevronUp, X, Tag, Brain, Eye, ThumbsUp, MessageSquare, Share, Calendar, Clock } from "lucide-react"
...
function VideoDialog({ video, isOpen, onClose, onSave, preachers, onTranscribe, onAIAnalysis }: {
  video: Video | null
  isOpen: boolean
  onClose: () => void
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            {video ? <Edit className="h-5 w-5" /> : <Plus className="h-5 w-5" />}
            {video ? "Edit Video" : "Add New Video"}
          </DialogTitle>
          <DialogDescription>
            {video ? "Update video information and metadata" : "Create a new video entry with comprehensive details"}
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="">No preacher</SelectItem>
